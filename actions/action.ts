...
export async function createInvoice(prevState: any, formData: FormData) {
    ...
    //   subject: "Votre facture du mmois est arrivée",
    //   text: "Hey, comment allez-vous, il y a une nouvelle facture pour vous !",
    ...
    emailClient.send({
      ...
      template_variables: {
        clientName: submission.value.clientName,
        invoiceNumber: submission.value.invoiceNumber,
        invoiceDueDate: new Intl.DateTimeFormat("fr-FR", {
          dateStyle: "long",
        ...
        invoiceLink:
          process.env.NODE_ENV !== "production"
            ? `http://localhost:3000/api/invoice/${data.id}`
            : `https://facto-hubert-78dz.vercel.app/api/invoice/${data.id}`,
      },
    });
