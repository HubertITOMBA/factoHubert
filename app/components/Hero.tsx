...
import HeroImage from "@/public/paid-gif.gif";
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className="text-center">
        ...
        Présentation de HubertFactures 1.0
        </span>
        ...
        Créer des factures peut être fastidieux ! Chez HubertFactures, nous vous facilitons la tâche pour être payé à temps !
        </p>

        <div className="mt-7 mb-12">
          <Link href="/login">
            <RainbowButton>Obtenez un accès illimité</RainbowButton>
