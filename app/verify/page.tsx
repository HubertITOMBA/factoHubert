...
export default function Verify() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center shadow-3xl">
        ...
        <Card className="w-[380px] px-5">
            <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl font-bold">Vérifiez votre e-mail</CardTitle>
                <CardDescription>
        ...
        <CardFooter>
          ...
          >
             <ArrowLeft className="size-4 mr-2" /> Retour à la page d'accueil
          </Link>
        </CardFooter>
        </Card>
    </div>
